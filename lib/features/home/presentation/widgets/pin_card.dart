...
import '../../../../global/widgets/pinterest_long_press_menu/Presentation/Screen/pinterest_long_press_menu.dart';
...
class PinCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PinterestLongPressMenu(
      imageUrl: pin.imageUrl,
      onSave: () {
        // Call your save provider here
        print("Saved!");
      },
      onSearch: () {
        print("Search Visual");
