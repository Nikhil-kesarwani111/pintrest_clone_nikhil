    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            // 1. Title Header ("Inbox" + Edit Icon)
            SliverPadding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {},
                      icon: Icon(
                        CupertinoIcons.pencil_ellipsis_rectangle, // Looks closest to the edit icon
                        size: 28.sp(context),
                        color: AppColors.black,
                      ),
                    ),
              ...
              sliver: SliverToBoxAdapter(
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    // Using InkWell for the "See all >" tap area
                    GestureDetector(
                      onTap: () {},
                      child: Row(
                        children: [
